...
SqfliteDatabaseFactory get sqfliteDatabaseFactory =>
    ...
    (databaseFactoryOrNull ?? databaseFactorySqflitePlugin) as SqfliteDatabaseFactory;

final SqfliteDatabaseFactory _databaseFactorySqflitePlugin = SqfliteDatabaseFactoryImpl();

/// Default factory that uses the plugin.
DatabaseFactory get databaseFactorySqflitePlugin => _databaseFactorySqflitePlugin;
...
@visibleForTesting
set sqfliteDatabaseFactory(SqfliteDatabaseFactory? databaseFactory) => sqflite_common.databaseFactory = databaseFactory;
...
class SqfliteDatabaseFactoryImpl with SqfliteDatabaseFactoryMixin {
  ...
  @override
  Future<T> wrapDatabaseException<T>(Future<T> Function() action) => impl.wrapDatabaseException(action);

  @override
  Future<T> invokeMethod<T>(String method, [Object? arguments]) =>
      !_debugInternals ? impl.invokeMethod(method, arguments) : _invokeMethodWithLog(method, arguments);
